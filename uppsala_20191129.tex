...
\begin{tikzpicture}[level distance=18mm, sibling distance=28mm, ->, thick,
  ...
  \tikzstyle{word} = [font=\rmfamily,color=black]
    ...
    \draw[red,very thick,->,visible on=<2>] (takingabreak) to node [auto] {} (taking);
    \draw[red,very thick,->,visible on=<2>] (takingabreak) to node [auto] {} (a);
    \draw[red,very thick,->,visible on=<2>] (takingabreak) to node [auto] {} (break);
