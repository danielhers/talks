...
\section{Cross-lingual Semantic Parsing with UCCA (SemEval'19)}

\begin{frame}
\frametitle{Shared Task}
\begin{itemize}
\item Data: UCCA English Wiki, English-French-German 20K
\item Baseline: TUPA
...
\begin{frame}
\frametitle{Shared Task Conclusion}
\Large
\begin{itemize}
\item Substantial improvements to UCCA parsing 
\item High variety of methods
\item Successful cross-lingual transfer
\end{itemize}

\end{frame}

\section{Content Differences in Syntactic and Semantic Representations (NAACL'19)}
...
\pause
\vfill
\begin{adjustbox}{padding=2mm,frame,minipage=\textwidth}
\centering
...
\vspace{5mm}
\large Evaluation Period: July 8--22, 2019
\end{adjustbox}
\end{frame}
