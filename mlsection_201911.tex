...
\begin{frame}
\frametitle{SemEval 2019 Shared Task: Cross-lingual UCCA Parsing}
\Large
\begin{itemize}
\item Data: English, French, German.
\item Tracks: $\{$in-domain/out-of-domain$\} \times \{$open/closed$\}$.
\item Baseline: TUPA
\item Participants: 8 teams from China, Vietnam, France, Germany, U.S., U.K.
\end{itemize}
\end{frame}
...
\includegraphics[width=.3\textwidth]{hltsuda1}
\includegraphics[width=.3\textwidth]{hltsuda2}
\includegraphics[width=.3\textwidth]{hltsuda3}
\end{frame}
