...
\vfill
\onslide<8>{
\textit{BERT}\footnote{Bidirectional Encoder Representations from Transformers} (2018):
\begin{itemize}
...
\textit{Rewarding Coreference Resolvers for Being Consistent with World Knowledge} (2019)
