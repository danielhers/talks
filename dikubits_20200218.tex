...
\only<1>{\includegraphics[width=\textwidth]{t5.png}}
\vfill
...
\pause
  \begin{center}
  \fbox{\small Violence in games hardens children to unethical acts | Violent games are harmful}
