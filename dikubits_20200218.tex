...
[Meaning Representation] and [(Meaning Representation) Parsing] \\
...
Learn {\only<6>{\color{red}}\textit{representations}}:
\[{\only<5>{\color{red}}\Sigma^*}\to{\only<6>{\color{red}}\mathbb{R}^n}\]

\pause
Train classifiers:
\[{\only<6>{\color{red}}\mathbb{R}^n}\to {\only<7>{\color{red}}Y}\]

\pause
Deploy:
\[{\only<5>{\color{red}}\Sigma^*}\to {\only<7>{\color{red}}Y}\]
