...
\begin{itemize}
 \item<1-> Meaning representations are useful for NLP, and NLG evaluation.
 \item<2-> They have accurate parsers for various frameworks and languages.
 \item<3-> Linguistic and supervised conversion enable deep comparison.
\end{itemize}

\vfill
\begin{center}
\onslide<1->{\includegraphics[width=.5\textwidth]{treasure_map}}
\end{center}
\end{frame}
...
\subsection{To Lexical Semantics}
...
\begin{center}
    ...
    \begin{tabular}{lrl}
        \textbf{$\underset{\text{STREUSLE}}{\text{Predicted UCCA}}$} & \textbf{Gold UCCA} \\
        \hline
        \bf Noun compounds \\{}
        $\underset{\sst{n.substance}}{\text{tap\_water}}$ (\textit{unanalyzable}) & [\ucca{E} tap] [\ucca{C} water] & \xmark \\{}
        [\ucca{\color{Pcolor}P} $\underset{\sst{n.event}}{\text{road\_construction}}$] & [\ucca{\color{Acolor}A} road] [\ucca{\color{Pcolor}P} construction] & \xmark \\\\{}
        \pause{}
        \bf Adverbs and linkage \\{}
        [\ucca{H} [\ucca{\color{Pcolor}P} $\underset{\sst{v.vid}}{\text{Gets\_busy}}$] ] [\ucca{L} so] [\ucca{H} [\ucca{\color{Pcolor}P} $\underset{\sst{v.motion}}{\text{come}}$] [\ucca{T} early]~] & [\ucca{H} [\ucca{D} Gets] [\ucca{\color{Scolor}S} busy]~] [\ucca{L} so] [\ucca{H} [\ucca{\color{Pcolor}P} come] [\ucca{T} early]~] & \xcmark
 \\{}
        [\ucca{L} so] [\ucca{H} [\ucca{\color{Scolor}S} easy] [\ucca{\color{Acolor}A} [\ucca{F} to] [\ucca{\color{Pcolor}P} $\underset{\sst{v.motion}}{\text{load}}$]~]~]  & [\ucca{D} [\ucca{E} so] [\ucca{C} easy]~] [\ucca{F} to] [\ucca{\color{Pcolor}P} load]  & \xmark \\\\{}
        \pause{}
        \bf Scene-evoking nouns \\{}
        \multirow{3}{5cm}{[\ucca{F} a] [\ucca{C} $\underset{\sst{n.food}}{\text{meal}}$] [\ucca{E} [\ucca{R} $\underset{\sst{p.locus}}{\text{on}}$] [\ucca{F} the] [\ucca{C} $\underset{\sst{n.communication}}{\text{menu}}$]~]~]} & [\ucca{F} a] [\ucca{C} meal] [\ucca{E} [\ucca{R} on] [\ucca{F} the] [\ucca{C} menu]~]~] & \cmark \\\\\\{}
        \multirow{2}{5cm}{[\ucca{\color{Pcolor}P} $\underset{\sst{v.communication}}{\text{answered}}$] [\ucca{\color{Acolor}A} [\ucca{Q} all] [\ucca{\color{Acolor}A} $\underset{\sst{p.gestalt}}{\underset{\sst{p.originator}}{\text{my}}}$] [\ucca{C} $\underset{\sst{n.communication}}{\text{questions}}$]~]} & [\ucca{\color{Pcolor}P} answered] [\ucca{\color{Acolor}A} [\ucca{D} all] [\ucca{\color{Acolor}A} my] [\ucca{\color{Pcolor}P} questions]~] & \xmark
    \end{tabular}
\end{center}
\end{frame}
...
\begin{itemize}
 \item Meaning representations are useful for NLP, and NLG evaluation.\pause
 \item They have accurate parsers for various frameworks and languages.\pause
