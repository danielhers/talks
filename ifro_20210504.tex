...
\begin{frame}
\includegraphics[width=\textwidth]{ucca_meaning}
\end{frame}
...
\begin{frame}
    \frametitle{Different Ways to Represent Meaning}
...
Improved parsing in 5 frameworks in English, French, German, Chinese and Czech.
\end{frame}

\begin{frame}
\frametitle{Meaning Representations Explain \textit{Human} Language Processing}
\includegraphics[width=\textwidth]{injecting}
...
\begin{frame}
\frametitle{Meaning Representations Make NLP Interpretable}
\begin{center}
...
\begin{frame}
\frametitle{Meaning Representations Help Answering Questions}
